...
\begin{center}
  ...
  {\large \textcolor{muted}{Research Design Document — v0.1}}\\[0.6em]
...
We identify this as the central open problem motivating the present
programme.
...
Explore icosahedral candidates at $N = 12$ and $N = 60$ as a high-risk,
high-reward target.
...
as three-dimensional knot diagrams, and animated GIFs of the full
choreographic motion for public dissemination.
